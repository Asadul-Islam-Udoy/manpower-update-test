...
function App() {
  ...
  useEffect(() => {
    if (!intervalId && userInfo?.user?.userType == "admin") {
  ...
  }, [dispatch, userInfo?.user?.userType == "admin", navigate, isLogout]);
          ...
          <div className="app">
            <main className="content">
              <Routes>
                ...
                <Route path="/user/forget/password/requiest" element={<ForgetPasswordRequest />} />
