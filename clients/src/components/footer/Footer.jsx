      ...
      <footer class=" text-white" style={{ background: 'linear-gradient(to right, #1f541e 5%, #523a0c, #a42e19)' }}>
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      height="20"
                      width="20"
                      className="w-10 h-10 p-2 border rounded-full shrink-0 border-slate-500-300"
        ...
        <div class="bg-[#133e0c] text-white py-2">
          <div class="container mx-auto text-center">
            ...
            <p>Copyright &copy; 2018 Career | ManPower. All rights reserved.</p>
          </div>
        </div>
      </footer> 
