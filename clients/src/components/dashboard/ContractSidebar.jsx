...
const ContractSidebar = ({ allclients, setUserId, userId, messageList }) => {
  const theme = useTheme();
  const colors = tokens(theme.palette.mode);
  ...
  return (
    ...
    >
      ...
      >
        <Box className=" bg-gray-200 py-2 shadow-lg w-full flex items-center justify-center">
          <Link to="/dashboard">
            <Typography className="text-black font-serif ">HOME</Typography>
          </Link>
        </Box>
