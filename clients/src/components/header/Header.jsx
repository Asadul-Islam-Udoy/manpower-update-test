      ...
      >
        ...
        <div className="relative mt-4 mb-0 md:hidden md:w-80">
          ...
          <Link
            ...
            className="flex items-center justify-center px-2 py-2 font-serif italic text-white list-none duration-75 border border-green-500 rounded-full shadow-lg cursor-pointer hover:text-orange-600 hover:border-orange-500"
          >
            Apply Workers
          </Link>
        </div>
