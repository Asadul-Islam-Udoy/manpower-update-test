...
import { DeleteResumeAction } from "../../action/auth_user/UserAction";
import LodderFrom from "../lodder/LodderFrom";
function DeleteModel({ workerId }) {
  const theme = useTheme();
  const colors = tokens(theme.palette.mode);
  const { lodding, isDeleteDelete } = useSelector(
          ...
          >
            ...
            <div class="flex justify-end items-center space-x-4  px-4 py-2 bg-slate-200">
              ...
              {lodding ? (
                ...
                <button
                  onClick={() => deleteHandler(workerId)}
                  autoFocus
