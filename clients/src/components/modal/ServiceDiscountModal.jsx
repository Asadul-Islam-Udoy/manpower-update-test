...
function ServiceDiscountModal({ id }) {
  ...
  const { lodding, allservices, error, isServiceDiscount } = useSelector(
  ...
  const [discount, setDiscount] = React.useState(singleService?.service_discount?.discount);
  const [discount_type, setDiscountType] = React.useState(singleService?.service_discount?.discount_type);
