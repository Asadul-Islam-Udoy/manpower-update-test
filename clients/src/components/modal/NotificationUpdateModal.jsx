...
import { updateNotificationByAdminAction } from "../../action/auth_admin/NotificationAction";
import { useDispatch } from "react-redux";
function NotificationUpdateModel({
  notificationId,
  userId,
  showUpdateModal,
  setShowUpdateModal,
  ...
  const notificationUpdateHandler=(userid,notificationId,notificationText,description,details_url,end_date)=>{
      dispatch(updateNotificationByAdminAction(userid,notificationId,notificationText,description,details_url,end_date))
  }
  return (
    <>
      {showUpdateModal && typeof document !== "undefined"
            ...
            >
              ...
              >
                ...
                <div className="flex justify-center gap-2">
                  <button onClick={()=>notificationUpdateHandler(userId,notificationId,notificationText,description,details_url,end_date)} className="inline-flex items-center justify-center w-full h-10 gap-2 px-5 text-sm font-medium tracking-wide text-white transition duration-300 rounded whitespace-nowrap bg-emerald-500 hover:bg-emerald-600 focus:bg-emerald-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-emerald-300 disabled:bg-emerald-300 disabled:shadow-none">
                    <span>Update</span>
                  </button>
                </div>
              </div>
...
export default NotificationUpdateModel;
