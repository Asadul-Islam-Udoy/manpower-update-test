...
import { deleteRoleAction, getAllRoleListsAction, refreshAuthAction } from "../../action/auth_admin/AdminAction";
function DeleteRoleModal({ roleId }) {
  const theme = useTheme();
  const colors = tokens(theme.palette.mode);
  const { lodding, isRoleDelete } = useSelector(
