...
function BookingInfo() {
  ...
  }, [dispatch, id, singlebooking?.ratings]);
      ...
      <div className="sidbar__app">
        ...
        >
          ...
          <div className="booking__information__container">
            <div className="booking__info__box" style={{ padding: "25px" }}>
              <div
                style={{
                  backgroundColor: isDarkMode ? "#1f2a40" : "#f5f5f5",
                  padding: "20px",
                  borderRadius: "8px",
                  color: isDarkMode ? "#f5f5f5" : "#1f2a40",
                }}
              >
                ...
                <div ref={contentRef} className="booking__info__container">
                  <h3
                    ...
                    style={{ color: isDarkMode ? "#f5f5f5" : "#1f2a40" }}
                  >
                    Booking Information
                  </h3>
                  <div>
                    ...
                    <div>
                      ...
                      {singlebooking?.workers?.map((item) => (
                        <Link
                          ...
                          to={`/profile/worker/my/manpower/${item.user._id}`}
                        >
                          <p
                          ...
                          >
                            <button
                              ...
                              className="w-full py-1 my-1 font-serif text-white bg-blue-500 border rounded-sm hover:text-black hover:bg-blue-400"
                            >
                              Information of{" "}
                    ...
                    <div className="w-40 ">
                      ...
                      >
                        <button
                          ...
                          className="w-full  py-1 my-1 font-serif text-black bg-blue-500 border rounded-sm hover:text-black hover:bg-blue-400"
                        >
                          Information of{" "}
