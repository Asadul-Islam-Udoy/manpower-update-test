...
const WorkerResume = () => {
  ...
  console.log('singleworker?.worker?.education_qualification',singleworker?.worker?.education_qualification)
  return (
    <>
      <Header />
              ...
              <div className="p-4">
                ...
                <div className="text-gray-600">
                  <ul>
                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Name:</span>
                      <span >{singleworker?.worker?.emergency_contract?.name}</span>
                    </li>

                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Relationship:</span>
                      <span>{singleworker?.worker?.emergency_contract?.relationship}</span>
                    </li>

                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Profession:</span>
                      <span>{singleworker?.worker?.emergency_contract?.profession}</span>
                    </li>

                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Mobile:</span>
                      <span>+880 {singleworker?.worker?.emergency_contract?.phone}</span>
                    </li>

                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Email:</span>
                      <span>{singleworker?.worker?.emergency_contract?.email}</span>
                    </li>

                    <li className="flex justify-between py-2 font-semibold border-b">
                      <span>Address:</span>
                      <span>{singleworker?.worker?.emergency_contract?.address}</span>
                    </li>
                  </ul>
                </div>
              </div>
