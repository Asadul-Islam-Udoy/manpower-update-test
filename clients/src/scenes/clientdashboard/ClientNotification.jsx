...
function ClientNotification() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-green">
        <div
          onClick={() => navigate(-1)}
          className="h-11 ml-1 w-11 cursor-pointer hover:text-blue-500 text-black flex justify-center items-center bg-white rounded-full"
        >
          <KeyboardArrowLeftIcon />
        </div>
        <div className="w-full flex items-center justify-center">
          <div
            className="relative md:min-h-[620px] min-h-[800px] mt-3 flex md:w-[92%] w-[100%] max-w-full flex-col  gap-4 overflow-hidden rounded bg-emerald-500 px-4 py-3 text-sm text-white shadow shadow-emerald-400/20 ring-1 ring-inset ring-emerald-600"
            role="status"
          >
            {/*  <!-- Text --> */}
