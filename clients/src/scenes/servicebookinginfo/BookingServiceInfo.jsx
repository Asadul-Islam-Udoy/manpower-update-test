...
const [amount, setAmount] = useState(advancePaymentMethod(cartItems));
          ...
          <div className="max-w-5xl p-6 mx-auto bg-transparent border rounded-lg shadow-md">
            ...
            <div className="flex items-center justify-center w-full">
              <p className="flex items-center justify-center p-3 mb-2 text-orange-300 rounded-sm shadow-lg w-96">
                ...
                <b className="ml-2"> {advancePaymentMethod(cartItems) || 0} </b> tk
              </p>
            </div>
            ...
            <div className="flex justify-between mt-8">
              ...
              <button
                disabled={buttonDisabled || advancePaymentMethod(cartItems) == 0}
                onClick={handleProceed}
                style={{ backgroundColor: buttonDisabled  || advancePaymentMethod(cartItems) == 0 ? "gray" : "green" }}
                className="px-4 py-2 text-white bg-green-500 rounded-lg"
              >
                <b>{advancePaymentMethod(cartItems) || 0} tk</b>Proceed
              </button>
            </div>
          </div>
        ) : (
