...
const WorkerApply = () => {
  ...
  const { error, isapply,  getsingleapplyresume } =
  ...
  return (
    <div className="py-10 pt-36 md:pb-20 md:mt-0 flex justify-center items-center fixed left-0 top-0 z-[1055] bg-blue-100 bg-opacity-65 h-full w-full overflow-y-auto overflow-x-hidden outline-none">
