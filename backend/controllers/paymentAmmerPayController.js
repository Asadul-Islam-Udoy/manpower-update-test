...
exports.createPaymentControler = async (req, res) => {
  try {
    ...
    const formData = {
      ...
      success_url: `https://manpower-update-test.onrender.com/api/payments/ammerpay/success/${traid_id}`,
      fail_url: `https://manpower-update-test.onrender.com/api/payments/ammerpay/fail/${traid_id}`,
      cancel_url: `https://manpower-update-test.onrender.com/api/payments/ammerpay/cancel/${traid_id}`,
      type: "json",
    };
...
exports.successPaymentControler = async (req, res) => {
  ...
  res.redirect('https://manpower-update-test.onrender.com/user/payment/success');
};
...
exports.failPaymentControler = async (req, res) => {
  ...
  res.redirect('https://manpower-update-test.onrender.com/user/payment/fails');
};
...
exports.cancelPaymentControler = async (req, res) => {
  ...
  res.redirect('https://manpower-update-test.onrender.com/user/payment/cancel'); 
};
